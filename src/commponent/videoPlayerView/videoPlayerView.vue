<template>
    <div class="bg-black w-screen h-screen pb-[-12vw] flex flex-wrap absolute">
      ...
      <!-- {/* 视频开始 */} -->
      <div
        class="w-[100%] h-[50vw] bg-[#FFF] absolute top-[19%]"
      ...
      <div class="w-[100%] absolute bottom-[0vw]">
        <div class="flex justify-between px-[4vw] items-end pb-[3vw]">
          ...
          <div class="flex-1 mr-[10vw]">
            ...
            <!-- {/* MV消息开始 */} -->
            <van-collapse v-model="activeNames" class="mb-[5vw] w-[72.85vw]">
            ...
            <!-- 歌曲名称轮播开始 -->
            <div class="flex items-center">
              <Icon icon="entypo:note" class="text-[3.8vw] text-[#b3b3b3]" />
              <van-notice-bar
                scrollable
          ...
          <div class="w-[10vw]">
            ...
            <div class="relative flex items-center justify-center">
              <img
                src="/static/1.png"
                alt=""
                class="w-[10vw] h-[10vw] rounded-[50%] gray-image"
              />
              <img
